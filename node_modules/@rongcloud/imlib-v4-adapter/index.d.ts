import { MessageDirection, IReadReceiptInfo, NotificationStatus, ConversationType, IReceivedMessage, APIContext, ISendMsgOptions, IUserProfile, IPushConfig, IMessageReaderResponse, IConversationTag, ErrorCode, ITagParam, ITagInfo, IChatroomInfo, RTCMode, IJoinRTCRoomData, IRTCRoomInfo, RTCApiType, KVString, IRTCUsers, IRtcTokenData, INaviInfo, ConnectionStatus, IChatroomListenerData, IExpansionListenerData, ITypingMessage, IBlockedMessageInfo, LogLevel, IPluginGenerator, FileType, IUploadAuth, UploadMethod, ChatroomEntryType } from '@rongcloud/engine';
export { ChatroomEntryType, ChatroomUserChangeType, ConnectionStatus, ConversationType, ErrorCode, FileType, IAndroidPushConfig, IBlockedMessageInfo, IChatroomEntryListenerData, IChatroomInfo, IChatroomListenerData, IChatroomRejoinedFailed, IChatroomRejoinedInfo, IChatroomRejoinedSuccessed, IChatroomUser, IChatroomUserChangeInfo, IConversationTag, IDeletedExpansion, IExpansionListenerData, IGooglePushConfig, IJoinRTCRoomData, ILogExtensions, ILogInfo, ILogInit, IMessageReader, IMessageReaderResponse, IPushConfig, IRTCRoomInfo, IRTCUsers, IReadReceiptInfo, IReceivedMessage, IRtcTokenData, ISendMsgOptions, IServerRTCRoomEntry, ITagInfo, ITagParam, ITypingMessage, ITypingUser, IUpdatedExpansion, IUserProfile, IiOSPushConfig, KVString, LogLevel, LogSource, LogTagId, MessageBlockType, MessageDirection, NotificationStatus, RTCApiType, RTCMode, UploadMethod, logger } from '@rongcloud/engine';
...
interface ITagListenerData {
    tagId: string;
    tagName: string;
}
interface IConversationTagListenerData {
    channelId?: string;
    conversationType: ConversationType;
    targetId: string;
}
...
export { CHATROOM_ENTRY_TYPE, CHATROOM_ORDER, CONNECTION_STATUS, CONNECT_TYPE, CONVERSATION_TYPE, Chatroom, ChatroomModule, Conversation, ConversationModule, ERROR_CODE, FILE_TYPE, GetHistoryMessageOption, GetHistoryMessageResult, IAReceivedConversation, IAReceivedMessage, IConversationContainTag, IConversationMergeOption, IConversationOption, IConversationTagListenerData, IConversationUpdateItem, IInitOption, IMClient, IReceivedAppInfo, IReceivedUpdateConversation, IRemoveChatroomEntryOption, ISetChatroomEntriesOption, ISetChatroomEntryOption, ITagListenerData, IWatchOptions, MENTIONED_TYPE, MESSAGE_DIRECTION, MESSAGE_TYPE, MESSAGS_TIME_ORDER, MentionedInfo, NOTIFICATION_STATUS, RECALL_MESSAGE_TYPE, RECEIVED_STATUS, RTCClient, RTCRoomOption, SDK_VERSION, Tag, TagModule, getInstance, init };
